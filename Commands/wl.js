        ...
        if(!args[0]){
            ...
            message.guild.channels.create(target.user.username, {type: "text", permissionOverwrites: [
                ...
                channel.send(new Discord.MessageEmbed() 
                    ...
                    .setDescription(`Vous disposez maintenant de votre propre salon privé pour faire des publicités avec **'Spy Ads** !
                    Rappelez-vous que vous devez avoir un ou plusieurs tokens de bot pour utiliser 'Spy Ads, si vous n'avez pas encore de token, adressez-vous à un helper pour en savoir plus.`)
                    .setColor(config.embedColor)
                )
    
                channel.send(new Discord.MessageEmbed() 
                    .setTitle("Utilisation de **'Spy Ads**")
                    .setDescription("Voici les commandes que vous pouvez utiliser avec **'Spy Ads**:")
